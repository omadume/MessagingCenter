...
class PackagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create package" do
    assert_difference("Package.count") do
      post packages_url, params: { package: { name: @package.name, passenger_id: @package.passenger_id } }
    end
  ...
  test "should update package" do
    patch package_url(@package), params: { package: { name: @package.name, passenger_id: @package.passenger_id } }
